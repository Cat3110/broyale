...
namespace SRDebugger.Profiler
{
    ...
    public class SRPProfilerService : SRServiceBase<IProfilerService>, IProfilerService
    {
        ...
        protected override void Awake()
        {
            ...
            UnityEngine.Rendering.RenderPipelineManager.beginFrameRendering += RenderPipelineOnBeginFrameRendering;
        ...
        private void RenderPipelineOnBeginFrameRendering(ScriptableRenderContext ctx, Camera[] obj)
        {
