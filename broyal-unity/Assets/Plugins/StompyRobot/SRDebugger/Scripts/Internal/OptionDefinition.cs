namespace SRDebugger.Internal
{
    public class OptionDefinition
    {
        ...
        public OptionDefinition(string name, string category, int sortPriority, SRF.Helpers.IPropertyReference property)
            : this(name, category, sortPriority)
        {
            Property = property;
        }
        ...
        public SRF.Helpers.IPropertyReference Property { get; private set; }       
    }
}
