namespace SRDebugger.UI.Controls
{
    ...
    public abstract class DataBoundControl : OptionsControlBase
    {
        ...
        private SRF.Helpers.IPropertyReference _prop;

        public SRF.Helpers.IPropertyReference Property
        {
            get { return _prop; }
        }  
        ...
        public void Bind(string propertyName, SRF.Helpers.IPropertyReference prop)
        {
        ...
        public override void Refresh(bool force = false)
        {
            ...
            if (currentValue != _prevValue || force)
            {
                try
                {
