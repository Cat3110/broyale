...
public class ItemGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#endif
        [ReadOnly] public ArchetypeChunkBufferType<ItemSnapshotData> ghostSnapshotDataType;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<ItemSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<ItemSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
                ComponentType.ReadOnly<PredictedGhostComponent>(),
            }
        });
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<ItemSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        ...
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<ItemSnapshotData>(true),
...
public partial class ItemGhostSpawnSystem : DefaultGhostSpawnSystem<ItemSnapshotData>
{
}
