...
public struct ItemSpawnerSnapshotData : ISnapshotData<ItemSpawnerSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref ItemSpawnerSnapshotData baseline1, ref ItemSpawnerSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref ItemSpawnerSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref ItemSpawnerSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref ItemSpawnerSnapshotData target, float factor)
    {
